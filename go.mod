...
require (
	...
	github.com/fujiwara/tfstate-lookup v0.0.14 // indirect
	...
	github.com/variantdev/chartify v0.8.5 // indirect
	github.com/variantdev/dag v1.0.0 // indirect
	github.com/variantdev/vals v0.13.0 // indirect
